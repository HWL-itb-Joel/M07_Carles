...
public class PlayerMover : MonoBehaviour
{
    ...
    private float _coyoteTime = 0.07f;
    ...
    private void Update()
    {
        ...
        foreach (Touch t in Input.touches) if (t.tapCount == 0.5 && _animator.GetCurrentAnimatorClipInfo(0)[0].clip.name != "Jump") jump();
       //CheckPlayerTouch();
    }
    ...
    private void animate()
    {
        ...
        _animator.SetBool("isGrounded", !jumping && (_controller.isGrounded || _timeSinceGrounded < _coyoteTime));
